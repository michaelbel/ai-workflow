...
| [Скиллы](#скиллы)         | `skills/`     | 20      | Пошаговые инструкции для конкретных задач реализации             |
...
- `generate-baseline-profile` — Заводит и верифицирует Android Baseline Profile: Macrobenchmark, генератор, CI.
