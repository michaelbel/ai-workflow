...
Предоставляет правила и скиллы AI-агентам в любом проекте. Данные всегда актуальны — сервер читает напрямую с GitHub. Сервер не привязан к Claude: его можно подключить к Codex, Cursor, Gemini CLI, Kimi Code или любому другому MCP-клиенту.
