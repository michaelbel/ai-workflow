...
export function createServer(options: CreateServerOptions = {}): McpServer {
  ...
  server.registerTool(
    "get_skill",
    {
      ...
      description: "Get the instructions for a skill. Use a name from the `list` tool, e.g. 'new-screen'.",
      inputSchema: {
        name: z.string().describe("Skill name (kebab-case directory name), e.g. 'new-screen'"),
      },
      outputSchema: {
        name: z.string(),
