---
description: >-
  Отдельный RealtimeDataSource на каждый hub или канал, общая инфраструктура соединения, регистрация
  обработчиков до подключения, conflatable invalidation через SharedFlow
paths:
  - "**/*.kt"
---
