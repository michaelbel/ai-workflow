...
The scope stops at "dashboard ready, API key in hand." SDK initialization code belongs to the [configuring-the-sdk](../configuring-the-sdk/) skill.
...
Hand off to [configuring-the-sdk](../configuring-the-sdk/) with:
